...
export default function ProjectCard({ project }) {
  ...
  return (
    <article className="group flex-shrink-0 w-[280px] sm:w-[300px] md:w-[360px] lg:w-[390px] xl:w-[420px] h-[373px] sm:h-[400px] md:h-[480px] lg:h-[520px] xl:h-[560px] bg-[var(--bg)] border-2 border-[var(--text)] rounded-4xl overflow-hidden flex flex-col transition-all duration-300 hover:-translate-y-2 hover:drop-shadow-xl">
      ...
      <div className="flex-1 flex flex-col justify-between p-4 sm:p-5 md:p-6">
        ...
        <div className="flex-1 space-y-2 sm:space-y-3">
          ...
          <p className="text-sm sm:text-base md:text-lg text-[var(--text)]/70 leading-relaxed line-clamp-1 sm:line-clamp-2 md:line-clamp-2 lg:line-clamp-3">
            {t(description)}
          </p>
        </div>
