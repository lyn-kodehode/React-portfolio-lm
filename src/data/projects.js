export const projects = [
  {
    ...
    title: "Shopfora",
    description: {
      no: "En moderne, responsiv e-handel applikasjon med et rent brukergrensesnitt og en smidig handleopplevelse",
      en: "A modern, responsive e-commerce application with a clean user interface and a smooth shopping experience",
    },
  ...
  },
  {
    ...
    description: {
      no: "Et personlig dashbord med værmeldinger, nyheter, boksøk og oppgavebehandling i sanntid",
      en: "A personal dashboard featuring real-time weather, news, book search, and task management",
    },
  ...
  },
  {
    ...
    description: {
      no: "Oppskriftsapp med API-integrasjon og lokal lagring",
      en: "Recipe app with API integration and local storage",
    },
  ...
  {
    id: 6,
    title: "Chad the Swimmer",
    description: {
      no: "Svømmespill med uendelig rullende kollisjon deteksjon",
      en: "Infinite scrolling swimming game with collision detection",
    },
